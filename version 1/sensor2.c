...
const uint8_t ikm[32] = { 0x70, 0xfb, 0x46, 0x64, 0xf4, 0x6f, 0x0e, 0xa0, 0x31, 0x75, 0x15, 0xe1, 0x40, 0x75, 0xbd, 0xde, 0x5f,
                           0x90, 0x80, 0x1b, 0x6f, 0xf6, 0x97, 0x41, 0xdb, 0x9a, 0xf0, 0x69, 0xd7, 0x30, 0xe1, 0x4e}; // the secret key
...
void encrypt(uint8_t *ciphertext, int cipher_size) {
    ...
    snprintf((char*)plaintext, sizeof(plaintext) - 1, "Humid: %d%%", sensor_value);
