...
const uint8_t ikm[32] = {0xd0, 0xf0, 0xbb, 0x8e, 0x3c, 0x83, 0xe5, 0x23, 0x17, 0x05, 0x32, 0x68, 0x34,
 0xdd, 0x29, 0x34, 0xae, 0x9a, 0x79, 0x9b, 0x42, 0xd4, 0x33, 0x0e, 0x5c, 0x55, 0x29, 0x71, 0x7a, 0x52, 0xd7, 0xe8}; // the secret key
...
void encrypt(uint8_t *ciphertext, int cipher_size) {
    ...
    snprintf((char*)plaintext, sizeof(plaintext) - 1, "Light: %d lux", sensor_value);
